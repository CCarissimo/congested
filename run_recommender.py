...
def main():
    from functions import vecSOrun, plot_run, vecSOrun_recommender
    import numpy as np
    ...
    M, Q = vecSOrun_recommender(N_AGENTS, N_STATES, N_ACTIONS, N_ITER, EPSILON, mask, GAMMA, ALPHA, QINIT, PAYOFF_TYPE, SELECT_TYPE)
