...
if __name__ == "__main__":
    ...
    NAME = "constant_epsilon"

    n_observations = int(size*2)  # state space
    ...
    with open(f"dqn_grid_data_{NAME}", "wb") as file:
        pickle.dump(data, file)

    with open(f"dqn_grid_drivers_{NAME}", "wb") as file:
